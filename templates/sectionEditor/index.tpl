...
<ul class="menu">
	<li{if ($pageToDisplay == "submissionsInReview")} class="current"{/if}><a href="{url path="submissionsInReview"}">{*{translate key="common.queue.short.submissionsInReview"}*}ໃນການທົບທວນ</a></li>
	<li{if ($pageToDisplay == "submissionsArchives")} class="current"{/if}><a href="{url path="submissionsArchives"}">{*{translate key="common.queue.short.submissionsArchives"}*}ບ່ອນເກັບຮັກສາເອກະສານ</a></li>
</ul>
<ul class="plain">
