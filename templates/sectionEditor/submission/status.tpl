 ...
 *}
<div id="status">
<h3>{translate key="common.statusS"}</h3>

<table width="100%" class="data">
	<tr>
		{assign var="status" value=$submission->getSubmissionStatus()}
		<td title="Current review status of the proposal" width="30%" class="label">[?] {translate key="common.statusS"}</td>
	...
	{/if}
	<tr>
		<td title="Decision's date of the above current status." class="label">[?] ວັນທີ</td>
