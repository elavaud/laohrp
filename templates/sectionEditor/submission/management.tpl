...
<table width="100%" class="data">
	<tr>
        ...
        <tr>
		<td title="Identification number of the research proposal." width="20%" class="label">[?] ລະຫັດບົດສະເຫນີ</td>
		<td width="80%" colspan="2" class="data">{$submission->getLocalizedWhoId()|escape}</td>
	</tr>
	<tr>
		<td title="Scientific title of the study as it appears in the protocol submitted for funding and ethical review. This title should contain information on population, intervention, comparator and outcome(s)." width="20%" class="label">[?] {translate key="article.titleS"}</td>
		<td width="80%" colspan="2" class="data">{$submission->getLocalizedTitle()|strip_unsafe_html}</td>
	</tr>
	<tr>
		<td title="Main file of the research proposal. Please click on its title (blue link) for downloading it." width="20%" class="label">{*{translate key="submission.originalFile"}*}[?] ຟາຍບົດສະເຫນີ</td>
	...
	<tr>
		<td title="The user who submitted the proposal through this health research portal. It could not be the same person as the investigator of the research." class="label">{*{translate key="submission.submitter"}*}[?] ຜູ້ສົ່ງບົດສະຫນີ</td>
	...
	<tr>
		<td title="The date when this proposal has been submitted to the Ethics Committee." class="label">{*{translate key="common.dateSubmitted"}*}[?] ວັນທີສົ່ງບົດສະຫນີ</td>
