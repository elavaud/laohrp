...
<table width="100%" class="data">
	...
	<tr>
		...
		<td><input type="checkbox" name="checkMohGrant" class="checkMonetary"/>&nbsp;MoH Grant (Lao PDR)</td>
		<td><input type="checkbox" name="checkGovernmentGrant" class="checkMonetary"/>&nbsp;Government Grant (Lao PDR)</td>
	</tr>
	<tr>
...
<table width="100%" class="data" id="geographicalAreas"  style="display:none">
	...
	<tr valign="top" id="nationwideField" style="display: none;">
		...
		<td colspan="2">
        	<input type="radio" name="nationwide" id="nationwidey" value="Yes" onclick="showOrHideProvince(this.value)"/>Yes
            &nbsp;&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="nationwide" id="nationwiden" value="No" onclick="showOrHideProvince(this.value)"/>No
        </td>
	</tr>
	
	<tr valign="top" id="firstProvince" class="province" style="display: none;">
		<td>&nbsp;</td>
		<td colspan="4" class="provinceTitle">Province(s)</td>
		<td colspan="4" class="noProvinceTitle" style="display: none;" align="right">OR &nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td colspan="2">
			<select name="provinces[]" id="provinces" class="selectMenu">
		 		<option value=""></option>
		 		{html_options options=$countriesOptions selected=$countries}
			</select>
			<a href="" class="removeProvince" style="display:none">Remove</a>
		</td>
	</tr>
	...
	<tr id="addAnotherProvince" style="display: none;">
    	<td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
        <td colspan="2"><a href="#" id="addAnotherProvince">Add another province</a></td>
    </tr>	
</table>
