...
{/if}
<tr valign="top">
	<td title="ຊື່ຜູ້ໃຊ້" width="20%" class="label">[?] {fieldLabel suppressId="true" name="username" key="user.username"}</td>
...
<tr valign="top">
	<td title="ເພດ" class="label">[?] {fieldLabel name="gender" key="user.gender"}</td>
	<td class="value">
...
<tr valign="top">
	<td title="ການຕິດຕໍ່" class="label">[?] {fieldLabel name="affiliation" key="user.affiliation"}</td>
	<td class="value">
...
<tr valign="top">
	<td title="ປະເທດ" class="label">[?] {fieldLabel name="country" key="common.country"}</td>
	<td class="value">
