...
<table class="listing" width="100%">
	<tr><td colspan="6"><strong>FOR FULL REVIEW</strong></td></tr>
	<tr><td colspan="6" class="headseparator">&nbsp;</td></tr>
	<tr class="heading" valign="bottom">
		<td width="20%">PROPOSAL ID / ລະຫັດບົດສະເຫນີ</td> <!-- Replaced id with ID, SPF, 21 Dec 2011 -->
		<td width="20%">Date submitted / ວັນທີສົ່ງບົດສະຫນີ</td>
		<td width="40%">{translate key="article.titleA" sort='title'}</td>
		<td width="20%">Investigator / ຜູ້ເຮັດການຄົ້ນຄວ້າ</td>
	</tr>
	<tr><td colspan="6" class="headseparator">&nbsp;</td></tr>
