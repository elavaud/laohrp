...
<tr valign="top">
	...
	<td width="80%">
		...
		{if $comment->getCommentTitle() neq ""}
			<div class="commentTitle">{if !$showReviewLetters}{translate key="submission.comments.subject"} / {/if}ຫົວຂໍ້: {$comment->getCommentTitle()|escape}</div>
		{/if}
		</div>
...
<table class="data" width="100%">
<tr valign="top">
	<td class="label">{if !$showReviewLetters}{translate key="submission.comments.subject"} / {/if}ຫົວຂໍ້</td>
