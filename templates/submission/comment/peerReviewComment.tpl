...
<table class="data" width="100%" cellpadding="10" style="width: 75em">
<tr valign="top">
	<td class="label" width="20%">{if $showReviewLetters}{fieldLabel name="commentTitle" key="submission.comments.subjectS"}{else}{fieldLabel name="commentTitle" key="submission.comments.subject"}{/if}</td>
...
<p><input type="submit" name="save" value="{if $showReviewLetters}{translate key="common.saveS"}{else}{translate key="common.save"}{/if}" class="button defaultButton" /> <input type="button" value="{if $showReviewLetters}{translate key="common.cancelS"}{else}{translate key="common.cancel"}{/if}" class="button" onclick="window.close()" /></p>
...
{else}
<input type="button" value="{translate key="common.cancelS"}" class="button defaultButton" style="width: 5em" onclick="window.close()" />
{/if}
