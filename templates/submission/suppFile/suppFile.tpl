...
{if $type == "Progress Report"}
    <h3>{translate key="submission.progressReports"} / ຍື່ນບົດລາຍງານຄວາມຄືບຫນ້າ ໄລຍະກາງຂອງ ການ ຄົ້ນຄວ້າ</h3>
{elseif $type == "Completion Report"}
    <h3>{translate key="submission.completionReports"} / ຍື່ນບົດລາຍງານລ້າສຸດຂອງການຄົ້ນຄວ້າ</h3>
{elseif $type == "Extension Request"}
    <h3>{translate key="submission.extensionRequest"}</h3>
{elseif $type == "Raw Data File"}
    <h3>{translate key="submission.rawDataFile"} / ສົ່ງຂໍ້ມູນດິບ</h3>
{elseif $type == "Other Supplementary Research Output"}
    <h3>{translate key="submission.otherSuppResearchOutput"} / ສົ່ງຜົນການຄົ້ນຄວ້າເພີ້ມເຕີມອື່ນໆ</h3>
{else}
        ...
        {if $type == "Supp File"}
            <tr>
                ...
                <td width="35%" class="value">
                        <select name="fileType[]" id="fileType" multiple="multiple" size="9" class="selectMenu">
                ...
                <td style="vertical-align: bottom;">
                        <div id="divOtherFileType" style="display: none;">
                            <span title="ກະລຸນາລະບຸແຈ້ງ" class="label" style="font-style: italic;">[?] Specify "Other" file type</span> <br />
