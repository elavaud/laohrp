...
-->
    ...
    <div id="authors">
        <h3>{*translate key="article.authors"*}Investigator / ຜູ້ເຮັດການຄົ້ນຄວ້າ</h3>
...
{if $authorIndex == 1}<h3>Co-investigator(s)</h3>{/if}
        <table width="100%" class="data">
            ...
            <tr valign="top">
                <td title="ເບີໂທລະສັບ" width="20%" class="label">[?] {fieldLabel name="authorPhoneNumber" required="true" key="user.tel"}</td>
			...
			{/if}
            <tr valign="top">
                <td title="ການຕິດຕໍ່" width="20%" class="label">[?] {fieldLabel name="authors-$authorIndex-affiliation" required="true" key="user.affiliation"}</td>
                <td width="80%" class="value">
                    ...
                    <span title="(ສະຖາບັນຂອງທ່ານ, ຕົວຢ່າງ ມະຫາວິທະຍາໄລວິທະຍາສາດສຸຂະພາບ, ວຽງຈັນ)" class="instruct">[?] {translate key="user.affiliation.description"}</span>
                </td>
            </tr>
...
{/foreach}
        ...
        <br /><br />
        {if $authorIndex<3}<p><input type="submit" class="button" name="addAuthor" value="{*translate key="author.submit.addAuthor"*}Add a Co-Investigator / ຜູ້ເຮັດການຄົ້ນຄວ້າອື່ນໆ" /></p>{/if}
    </div>
    <div class="separator"></div>
<!--    
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
-->
    <div id="titleAndAbstract">
        <h3>{translate key="submission.titleAndAbstract"} / ຫົວຂໍ້ ແລະ ສັງລວມຫຍໍ້ບົດສະເຫນີການຄົ້ນຄວ້າ</h3>

        <table width="100%" class="data">
            <tr valign="top">
                <td title="ຊື່ທາງວິທະຍາສາດຂອງບົດສະເຫນີການຄົ້ນຄວ້າ
Scientific title of the study as it appears in the protocol submitted for funding and ethical review. This title should contain information on population, intervention, comparator and outcome(s)." width="20%" class="label">[?] {fieldLabel name="scientificTitle" required="true" key="proposal.scientificTitle"}</td>
            ...
            <tr valign="top">
                <td title="ຊື່ຫົວຂໍ້ທົ່ວໄປຂອງບົດສະເຫນີການຄົ້ນຄວ້າ
Title intended for the lay public in easily understood language." width="20%" class="label">[?] {fieldLabel name="publicTitle" required="true" key="proposal.publicTitle"}</td>
            ...
            <tr valign="top">
                <td title="ການຄົ້ນຄວ້າເປັນສ່ວນນື່ງທີ່ຈຳເປັນຂອງໃນການສຳເລັດການສຶກສາບໍ່?
...
Institution where the student is enrolled." style="font-style: italic;">[?] {fieldLabel name="studentInstitution" required="false" key="proposal.studentInstitution"}</span>&nbsp;&nbsp;
             ...
             <tr valign="top" id="academicDegreeField">
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ການຄົ້ນຄວ້າທີ່ໄດ້ເຮັດນີ້ສຳລັບລະດັບຂັ້ນການສຶກສາ
Academic degree in which the student is enrolled." style="font-style: italic;">[?] {fieldLabel name="academicDegree" required="false" key="proposal.academicDegree"}</span>&nbsp;&nbsp;
            ...
            <tr valign="top">
                <td title="ບົດຄັດຫຍໍ້ຂອງບົດສະເຫນີການຄົ້ນຄວ້າ
Short description of the primary purpose of the protocol, including a brief statement of the study hypothesis. It also includes publication/s details (link/reference), if any." width="20%" class="label">{if $section->getAbstractsNotRequired()==0}[?] {fieldLabel name="abstract" key="proposal.abstract" required="true"}{else}{fieldLabel name="abstract" key="proposal.abstract"}{/if}</td>
            ...
            <tr valign="top">
                <td title="ຄຳສັບຫລັກສຳລັບບົດສະເຫນີການຄົ້ນຄວ້າ
Significant or descriptive words." width="20%" class="label">[?] {fieldLabel name="keywords" required="true" key="proposal.keywords"}</td>
            ...
            <tr valign="top">
                <td title="ວັນທີເລີ້ມ" width="20%" class="label">[?] {fieldLabel name="startDate" required="true" key="proposal.startDate"}</td>
...
The Primary Sponsor is responsible for ensuring that the research is properly registered. The Primary Sponsor may or may not be the main funder." width="20%" class="label">
...
Additional individuals, organizations or other legal persons, if any, that have agreed with the primary sponsor to take on responsibilities of sponsorship. A secondary sponsor may have agreed: 
	...
	• to take responsibility for the accuracy of trial registration information submitted." width="20%" class="secondarySponsorTitle">{if $i == 0}[?] {fieldLabel name="secondarySponsors" key="proposal.secondarySponsors"}{/if}</td>
...
{/foreach}  
            <tr valign="top" id="otherSecondarySponsorField" {if $isOtherSecondarySponsorSelected == false}style="display: none;"{/if}>
                ...
                <td width="80%" class="value">
                <span title="ກະລຸນາລະບຸແຈ້ງ. 
If one ore more of your seconday sponsor(s) is/are not included in the liste, please specify it/them here." style="font-style: italic;">[?] {fieldLabel name="otherSecondarySponsor" required="true" key="proposal.otherSecondarySponsor"}</span>&nbsp;&nbsp;
            ...
            <tr valign="top">
                <td title="ຮ່ວມກັນຫລາຍປະເທດ: ສະຖານທີເຮັດການຄົ້ນຄວ້າບໍ່ໄດ້ເຮັດພຽງແຕ່ໃນປະເທດລາວ?
...
{foreach from=$multiCountry[$formLocale] key=i item=country}
            <tr valign="top" {if $i == 0}id="firstMultiCountry" class="multiCountry"{else}id="mutliCountryField" class="multiCountrySupp"{/if}>
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ເລືອກປະເທດ" style="font-style: italic;">[?] {fieldLabel name="multiCountry" required="true" key="proposal.multiCountry"}</span>&nbsp;&nbsp;
                    <select name="multiCountry[{$formLocale|escape}][]" id="multiCountry" class="selectMenu">
                        <option value="MCNA"></option>
...
{foreach from=$proposalCountry[$formLocale] key=i item=country}
            <tr valign="top" {if $i == 0}id="firstProposalCountry" class="proposalCountry"{else}id="proposalCountryField" class="proposalCountrySupp"{/if}>
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ເລືອກແຂວງ" style="font-style: italic;">[?] {fieldLabel name="proposalCountry" required="true" key="proposal.proposalCountry"}</span>&nbsp;&nbsp;
...
{foreach from=$researchField[$formLocale] key=i item=field}
            <tr valign="top"  {if $i == 0}id="firstResearchField" class="researchField"{else}id="researchFieldField" class="researchFieldSupp"{/if}>
                <td title="ສະຖານທີ່ຄົ້ນຄວ້າ" width="20%" class="researchFieldTitle">{if $i == 0}[?] {fieldLabel name="researchField" required="true" key="proposal.researchField"}{else} &nbsp; {/if}</td>
...
{/foreach}
            <tr valign="top" id="otherResearchFieldField" {if $isOtherResearchFieldSelected == false}style="display: none;"{/if}>
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ຖ້າ ສະຖານທີ່ຄົ້ນຄວ້າບໍ່ໄດ້ລວມຢູ່ໃນບັນຊີລາຍການ, ກະລຸນາລະບຸແຈ້ງ" style="font-style: italic;">[?] {fieldLabel name="otherResearchField" key="proposal.otherResearchField"}</span>&nbsp;&nbsp;
            ...
            <tr valign="top">
                <td title="ການຄົ້ນຄວ້າກ່ຽວກັບຄົນບໍ່?" width="20%" class="label">[?] {fieldLabel name="withHumanSubjects" required="true" key="proposal.withHumanSubjects"}</td>
                <td width="80%" class="value">
...
{foreach from=$proposalType[$formLocale] key=i item=type}
            <tr valign="top" {if $i == 0}id="firstProposalType" class="proposalType"{else}id="proposalTypeField" class="proposalTypeSupp"{/if}>
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ຮູບແບບຂອງບົດສະເຫນີ" style="font-style: italic;">[?] {fieldLabel name="proposalType" required="false" key="proposal.proposalType"}</span>&nbsp;&nbsp;
...
{/foreach}          
            <tr valign="top" id="otherProposalTypeField" {if $isOtherProposalTypeSelected == false}style="display: none;"{/if}>
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ຖ້າ ຮູບແບບຂອງໂຄງການສະເຫນີຄົ້ນຄວ້າ ບໍ່ໄດ້ລວມຢູ່ໃນບັນຊີລາຍການ, ກະລຸນາລະບຸແຈ້ງ" style="font-style: italic;">[?] {fieldLabel name="otherProposalType" key="proposal.otherProposalType" required="true"}</span>&nbsp;&nbsp;
            ...
            <tr valign="top">
                <td title="ບົດສະເຫນີຄົ້ນຄວ້າ ໄດ້ທົບທວນໂດຍຄະນະກຳມະການທົບທວນດ້ານຈັນຍາທຳ?" width="20%" class="label">[?] {fieldLabel name="reviewedByOtherErc" required="true" key="proposal.reviewedByOtherErc"}</td>
                <td width="80%" class="value">
            ...
            <tr valign="top" id="otherErcDecisionField">
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ຖ້າແມ່ນ, ການຕັດສິນຂອງຄະນະກຳມະການດ້ານຈັນຍາທຳອື່ນໆ" style="font-style: italic;">[?] {fieldLabel name="otherErcDecision" required="false" key="proposal.otherErcDecision"}</span>&nbsp;&nbsp;
    ...
    <div id="sourcesOfGrant">
        ...
        <table width="100%" class="data">
            ...
            <tr valign="top" id="nameOfIndustryField"  style="display: none;">
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                    <span title="ກະລຸນາລະບຸແຈ້ງຊື່ຂອງພາກສ່ວນອຸດສາຫະກຳທີ່ສະຫນັບສະຫນຸນ" style="font-style: italic;">[?] {fieldLabel name="nameOfIndustry" required="true" key="proposal.nameOfIndustry"}</span>&nbsp;&nbsp;
                    <input type="text" name="nameOfIndustry[{$formLocale|escape}]" id="nameOfIndustry" size="20" value="{$nameOfIndustry[$formLocale]|escape}" />
                </td>
            </tr>
        	<tr valign="top">
                <td title="ທືນຊ່ວຍເຫລືອລ້າຈາກສາກົນ" width="20%" class="label">[?] {fieldLabel name="internationalGrant" required="true" key="proposal.internationalGrant"}</td>
                <td width="80%" class="value">
...
{foreach from=$internationalGrantName[$formLocale] key=i item=type}
            <tr valign="top" {if $i == 0}id="firstInternationalGrantName" class="internationalGrantName"{else}id="internationalGrantNameField" class="internationalGrantNameSupp"{/if}>
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                	<span title="ກະລຸນາລະບຸແຈ້ງ" style="font-style: italic;">[?] {fieldLabel name="internationalGrantName" required="true" key="proposal.internationalGrantName"}</span>&nbsp;&nbsp;
...
{/foreach}  
            <tr valign="top" id="otherInternationalGrantNameField" {if $isOtherInternationalGrantNameSelected == false}style="display: none;"{/if}>
                <td width="20%" class="label"></td>
                <td width="80%" class="value">
                <span title="ກະລຸນາລະບຸແຈ້ງຊື່ຂອງອົງກອນທີ່ສະຫນັບສະຫນຸນ" style="font-style: italic;">[?] {fieldLabel name="otherPrimarySponsor" required="true" key="proposal.otherInternationalGrantName"}</span>&nbsp;&nbsp;
        	...
        	<tr valign="top">
                <td title="ທືນຊ່ວຍເຫລືອລ້າຈາກກະຊວງສາທາລະນະສຸກ" width="20%" class="label">[?] {fieldLabel name="mohGrant" required="true" key="proposal.mohGrant"}</td>
                <td width="80%" class="value">
        	...
        	<tr valign="top">
                <td title="ທືນຊ່ວຍເຫລືອລ້າຈາກລັດຖະບານລາວ(ບໍ່ແມ່ນຈາກກະຊວງສາທາລະນະສຸກ)" width="20%" class="label">[?] {fieldLabel name="governmentGrant" required="true" key="proposal.governmentGrant"}</td>
                <td width="80%" class="value">
            ...
            <tr valign="top" id="governmentGrantNameField" style="display: none;">
                <td width="20%" class="label">&nbsp;</td>
                <td width="80%" class="value">
                    <span title="ກະລຸນາລະບຸແຈ້ງ" style="font-style: italic;">[?] {fieldLabel name="governmentGrantName" required="true" key="proposal.governmentGrantName"}</span>&nbsp;&nbsp;
        	...
        	<tr valign="top">
                <td title="ທືນເຮັດການຄົ້ນຄວ້າຈາກມະຫາວິທະຍາໄລ" width="20%" class="label">[?] {fieldLabel name="universityGrant" required="true" key="proposal.universityGrant"}</td>
                <td width="80%" class="value">
        	...
        	<tr valign="top">
                <td title="ທືນສ່ວນຕົວ" width="20%" class="label">[?] {fieldLabel name="selfFunding" required="true" key="proposal.selfFunding"}</td>
                <td width="80%" class="value">
        	...
        	<tr valign="top">
                <td title="ອື່ນໆ" width="20%" class="label">[?] {fieldLabel name="otherGrant" required="true" key="proposal.otherGrant"}</td>
                <td width="80%" class="value">
            ...
            <tr valign="top" id="specifyOtherGrantField"  style="display: none;">
            	<td width="20%" class="label">&nbsp;</td>
            	<td width="80%" class="value">
					<span title="ກະລຸນາລະບຸແຈ້ງ" style="font-style: italic;">[?] {fieldLabel name="specifyOtherGrant" required="true" key="proposal.specifyOtherGrantField"}</span>&nbsp;&nbsp;
