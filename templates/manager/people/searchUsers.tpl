...
function showOrHideEthicsCommitteeField() {ldelim}
    ...
    {rdelim} else if(isExtReviewerSelected) {ldelim}
        $('#submit').show();
        $('#extReviewerSelected').show();
        $('#noEthicsCommitteeSelected').hide();
        $('#nothingSelected').hide();
        $('#noMemberStatusSelected').hide();
        $('#ethicsCommitteeField').hide();
	...
	<tr valign="top" id="roleIdField">
    	...
    	<td width="80%" class="value">
			<select name="roleId" multiple="multiple" size="5" id="roleId" class="selectMenu">
				...
				<option value="ExtReviewer">External Reviewer</option>
...
<p id="extReviewerSelected" style="display: none;"><font color=#00CC33>
Please note that an external reviewer can't be an ERC member, an ERC secretary, an administrator or a coordinator.<br/>
</font>
</p>
<!---->
...
<strong>ATTENTION :</strong><br />
A Secretary is already set in the UHS Ethics Committee:<br />
</font>
