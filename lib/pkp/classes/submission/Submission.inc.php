...
class Submission extends DataObject {
	...
	function Submission() {
		...
		$this->removedAuthors = array();
                $this->provincesOfLaosDAO =& DAORegistry::getDAO('ProvincesOfLaosDAO');
	...
	function getLocalizedProposalCountryText() {
		return $this->provincesOfLaosDAO->getProvinceOfLaos($this->getLocalizedProposalCountry());
	}
